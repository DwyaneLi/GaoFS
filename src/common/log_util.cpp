...
spdlog::level::level_enum gaofs::log::get_level(string level_str) {
    char* parse_end;
...
spdlog::level::level_enum gaofs::log::get_level(unsigned long level) {
    switch(level) {
        case 0:
            return spdlog::level::off;
        case 1:
...
void gaofs::log::setup(const vector<string>& loggers_name, spdlog::level::level_enum level, const string& path) {
